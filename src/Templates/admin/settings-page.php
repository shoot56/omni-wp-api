...
<div class="omni-config wrap">
    ...
    <div id="omni_modal" class="omni-form-modal">
        ...
        <div class="omni-project-modal-content">
            ...
            <input type="text" id="projectName" placeholder="<?php esc_html_e('Project name', 'omni-wp-api'); ?>"
                   class="omni-input">
            <button id="submitProject"
                    class="btn-omni btn-omni--primary">
                <?php esc_html_e('Create project', 'omni-wp-api'); ?>
            </button>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-row__item">
                                    <div class="inputs-wrap">
                                        <select name="existing_project" class="form-input"
                                                id="existing_project">
                                ...
                                <div class="form-row__item">
                                    ...
                                    <div class="form-info">
                                        <ol>
                                            ...
                                            <li>Get a key at <a href="#">Settings - Profile - API Keys</a>
                                                section
                                            </li>
